...
let CustomerController = class CustomerController {
    ...
    create(req, res) {
        if (req && req.body) {
            ...
            const customerIndex = this.customerService.customers.findIndex((customer) => customer.email === email);
            if (customerIndex === -1) {
...
__decorate([
    (0, common_1.Put)('gfit-connect'),
    __param(0, (0, common_1.Req)()),
    __param(1, (0, common_1.Res)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", void 0)
], CustomerController.prototype, "gfitConnect", null);
